...
class AlliedTeleHealthScreen extends StatefulWidget {
  const AlliedTeleHealthScreen({super.key});

  @override
  State<AlliedTeleHealthScreen> createState() => _AlliedTeleHealthScreenState();
}

class _AlliedTeleHealthScreenState extends State<AlliedTeleHealthScreen>
