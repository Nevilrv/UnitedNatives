...
class IhAppScreen extends StatefulWidget {
  const IhAppScreen({Key key}) : super(key: key);

  @override
  State<IhAppScreen> createState() => _IhAppScreenState();
}

class _IhAppScreenState extends State<IhAppScreen> {
  Future aboutTheIhApp() async {
    http.Response response = await http.get(
      Uri.parse('${Constants.baseUrl + Constants.aboutIHApp}'),
    );
