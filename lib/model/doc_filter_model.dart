...
//
//     final docFilterModel = docFilterModelFromJson(jsonString);

import 'dart:convert';

List<DocFilterModel> docFilterModelFromJson(String str) => List<DocFilterModel>.from(json.decode(str).map((x) => DocFilterModel.fromJson(x)));

String docFilterModelToJson(List<DocFilterModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
