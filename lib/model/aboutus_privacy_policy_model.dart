class AboutUsPrivacyPolicyModel {
  String? _status;
  Data? _data;

  AboutUsPrivacyPolicyModel({String? status, Data? data}) {
    _status = status;
    _data = data;
  }
  ...
  AboutUsPrivacyPolicyModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    _aboutUnh = json['about_ih'] as String?;
    _privacyPolicy = json['privacy_policy'] as String?;
  }
