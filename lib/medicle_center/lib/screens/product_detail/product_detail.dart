...
import 'package:united_natives/medicle_center/lib/blocs/product_detail/product_detail_cubit.dart';
...
import 'package:united_natives/medicle_center/lib/configs/image.dart';
...
import 'package:united_natives/medicle_center/lib/widgets/app_download_file.dart';
...
import 'package:united_natives/medicle_center/lib/widgets/app_tag.dart';
import 'package:united_natives/medicle_center/lib/widgets/app_video.dart';
...
class _ProductDetailState extends State<ProductDetail> {
  ...
  Widget _buildContent(ProductModel? product) {
    ...
    if (product != null) {
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          child: Builder(builder: (context) {
                            final startTime =
                                hour.split("-").first.split(":").first;

                            final endTime =
                                hour.split("-").last.split(":").first;

                            final finalTime =
                                "${int.parse(startTime) == 12 || int.parse(startTime) == 00 ? 12 : int.parse(startTime) > 12 ? (int.parse(startTime) - 12) : startTime}:${hour.split("-").first.split(":").last} ${int.parse(startTime) == 12 ? "PM" : int.parse(startTime) > 12 ? "PM" : "AM"}-${int.parse(endTime) == 12 || int.parse(endTime) == 00 ? 12 : int.parse(endTime) > 12 ? (int.parse(endTime) - 12) : endTime}:${hour.split("-").last.split(":").last} ${int.parse(endTime) == 12 ? "PM" : int.parse(endTime) == 24 || int.parse(endTime) == 00 ? "AM" : int.parse(endTime) > 12 ? "PM" : "AM"}";
      ...
      ///Booking button
      if ("${product.bookingStyle}".isNotEmpty &&
          (product.bookingUse ?? false)) {
        booking = InkWell(
          onTap: _onBooking,
          child: Container(
            height: 26,
