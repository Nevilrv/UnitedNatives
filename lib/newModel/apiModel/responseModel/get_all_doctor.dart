...
GetAllDoctorResponseModel getAllDoctorResponseModelFromJson(String str) =>
    GetAllDoctorResponseModel.fromJson(json.decode(str));

String getAllDoctorResponseModelToJson(GetAllDoctorResponseModel data) =>
...
class GetAllDoctorResponseModel {
  ...
  factory GetAllDoctorResponseModel.fromJson(Map<String, dynamic> json) =>
      GetAllDoctorResponseModel(
        status: json["status"],
